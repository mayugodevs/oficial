...
@section('content')
    <div class="dark:bg-gray14 bg-whiteheader">
        ...
        <div class="containermygo mx-auto pt-44 pb-10 ml:px-0 xl:px-0 lg:px-0 md:px-8 px-4">
            ...
            <div class="pt-10">
                ...
                <div class="px-8 py-5 dark:bg-pricingcintadark bg-bgfondopricingwhite rounded-b-xl">
                        ...
                        <div role="banner" class=" ">
                            <svg class="text-delesteicono dark:text-green_home" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="dark:text-pricingdarkstudents text-gray-600 pt-2 font-inter font-normal text-sm">
                                    ...
                                    que podrá disfrutar de los mismos beneficios de tu plan. Invita a un familiar o un amigo con su correo electrónico.
                                </div>
                                <div class="pt-6">
                                    <input type="" placeholder="Ingrese el correo del beneficiario" class="border placeholder-gray-650 text-gray-500 dark:text-bgprogresb dark:placeholder-bgprogresb font-inter text-sm font-medium rounded-md h-10 pl-3  bg-transparent focus:outline-none w-full dark:border-gray-600 border-pricingdarkstudents">
                                </div>
