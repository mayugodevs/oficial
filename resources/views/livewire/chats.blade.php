<div class="dark:bg-gray14 bg-whiteheader  h-auto">
    <style>
        .footeracceso {
        ...
        <div class=" grid sm:grid-cols-6 grid-cols-1 bg-white">
            ...
            <div  class=" bloqueuno col ml:col-span-2 xl:col-span-2 lg:col-span-3 md:col-span-3 col-span-1 border-r-2  border-borderconcours dark:border-gray-650 ">
                ...
                @foreach ($users as $user)
                    {{-- @php
                    $tipo = $user->tipo == 0 ? 'Docente' : ($user->tipo == 1 ? 'Alumno' : 'Admin');
                @endphp --}}
                    <div class=" activebloqueuno flex flex-col py-4 px-4 justify-center items-center hover:bg-bgprogresb focus:bg-bgprogresb border-b-2 dark:hover:bg-txtnamecomntpkyr dark:focus:bg-txtnamecomntpkyr  border-borderconcours dark:border-gray-650"
                        wire:click="openChat({{ $user->idalum }})">
            ...
            <div  class="bloquedos col ml:col-span-4 xl:col-span-4 lg:col-span-3 md:col-span-3 col-span-1 justify-between pb-16  pt-6">
                <div class="flex flex-col pt-0 relative ">
                    ...
                    @else
                                ...
                                <div class="flex items-center gap-x-4 sm:px-6 px-4  ">
                                    <div class="relative">
                                        <img src="https://source.unsplash.com/vpOeXr5wmR4/600x600"
                                            class="object-cover h-14 w-14  rounded-full" alt="" />
                        ...
                        <div class="pb-10">
                        <div class="sm:pl-8 pl-4 lg:pr-8 xl:pr-4 ml:pr-4 md:pr-8 pr-4 pb-4 overflow-y-scroll pt-32"
                            style="height: 680px;">
                            @foreach ($messages as $message)
                                ...
                                @endphp
                                <div class=" {{ $type[0] }} pb-2 ">
                                    @if ($message->envio == $userme)
                                        <img src="{{ asset($message->alumno->avatar) }}"
                                    ...
                                    <div class="flex flex-col pb-0">
                                        <div class="flex justify-between pl-2 items-end">
                                            ...
                                            <div
                                                ...
                                                @if ($message->difTime($message->fecha))
                                                    {{ $message->difTime($message->fecha) }}
                                                @else
                                                    <div class=" ">
                                                        {{ $message->fecha->translatedFormat('d M  H:i:s') }}</div>
                                                @endif
                                        ...
                                        <div class="{{ $type[1] }} ">
                                            ...
                                            {{-- <span class="text-xs text-red-500 ">
                                                @if ($message->difTime($message->fecha))
                                                    {{ $message->difTime($message->fecha) }}
                                                @else
                                                    {{ $message->fecha->translatedFormat('d M Y H:i:s') }}
                                                @endif
                                        ...
                                        <div class="relative">
                                            ...
                                            <div class="absolute top-5 right-0 bg-transparent text-right  hidden mr-4" id="componente">
                ...
                <div class="fixed w-full chatswidth bottom-6 ">
                    <div class="pt-5  sm:flex hidden  relative sm:pl-8 pl-4 xl:pr-0 ml:pr-0 lg:pr-2 md:pr-4 pr-4 ">
                        <input
                        ...
                        <div
                            class="absolute  lg:right-4 md:right-6 xl:right-2 ml:right-3  flex items-center gap-x-3 lg:bottom-3 bottom-2">
                            <button>
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <input class="bg-pricingtextduowhite text-sixteen h-10 rounded-lg px-5 text-white-100"
                                type="button" value="Enviar" wire:click="sendMessage">
                ...
                <div class="pt-5  items-center sm:hidden flex gap-x-3 px-4">
                    ...
                    <div class=" flex items-center relative gap-x-3 ">
                        ...
                        <input
                            ...
                            type="button" value="" wire:click="sendMessage">
                        <div class="absolute left-2.5">
                            <svg class="dark:text-pricingtextduowhite text-white-100" width="20" height="20"
