<div class="bg-gray-50 dark:bg-gray-600 px-38 py-14  grid grid-cols-12">
    ...
    <div class=" max-w-7xl px-20 col-span-1 grid grid-cols-1 gap-y-24 sm:grid-cols-2 sm:gap-x-10 sm:gap-y-10 md:grid-cols-2 lg:grid-cols-1 lg:col-span-7 ">
        <div class="bg-gray-200 dark:bg-gray-800 flex items-center space-x-4 p-6 md:px-10 md:py-6  leading-6 font-semibold text-white">
            ...
            <div class="flex-auto">
                <dt class="text-sm">Kenny Miller</dt>
