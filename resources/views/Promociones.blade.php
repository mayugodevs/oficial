...
@section('content')
            ...
            <div
                ...
                <div class="lg:order-1 order-2">
                    <div class=" lg:text-left text-center">
                        ...
                        <div
                            class="text-bcklightbuscador dark:text-bgbtngreen font-inter font-bold italic text-thirty-two pt-6">
                            ¡A tan solo usd 9.99 cada uno!
                        </div>
                        <div class="dark:text-borderconcours text-txtcommentply font-inter font-normal text-sm pt-6">
    ...
    <div class="dark:bg-gray14 bg-whiteheader">
        {{-- <div class="containermygo mx-auto pt-10 pb-40">
            <div class="grid xl:grid-cols-4 ml:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 ml:px-0 xl:px-0 lg:px-8 md:px-8 px-4 gap-x-5">
                <div class="xl:col-span-3 ml:col-span-3 lg:col-span-2 md:col-span-2 col-span-1 xl:grid-cols-3 ml:grid-cols-3 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-x-5 grid gap-y-10">
                    <div>
                ...
                <div class="xl:col-span-1 ml:col-span-1 lg:col-span-2 md:col-span-2 xsm:col-span-2 col-span-1 xl:pt-0 pt-10  ">
                    <div>
        ...
        <div class="containermygo mx-auto pt-10 pb-48">
            <div
                class="grid xl:grid-cols-4 ml:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-x-5 gap-y-8 ml:px-0 xl:px-0 lg:px-8 md:px-8 px-4">
                <div>
                    <div class="dark:bg-pricingcintadark bg-bgfondopricingwhite pt-5 pb-7 rounded-t-xl ">
                        <svg class="mx-auto" width="81" height="80" viewBox="0 0 81 80" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path
                                d="M41.4626 34.5383L42.6641 28.606M23.0801 41.9061L26.9162 33.691L23.0801 41.9061ZM28.0696 33.5594L30.8957 37.9438L32.1593 37.9864L33.9366 34.5072L28.0696 33.5594ZM35.5521 33.5172L40.0252 35.6005L35.5521 33.5172Z"
                                stroke="white" stroke-width="0.711966" stroke-miterlimit="22.9256" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path
                                d="M27.3859 33.7948C27.9995 33.7948 28.4968 33.2974 28.4968 32.6838C28.4968 32.0702 27.9995 31.5728 27.3859 31.5728C26.7723 31.5728 26.2749 32.0702 26.2749 32.6838C26.2749 33.2974 26.7723 33.7948 27.3859 33.7948Z"
                                stroke="white" stroke-width="0.890036" stroke-miterlimit="22.9256" />
            ...
            <div class=" inset-x-0 w-full  dark:bg-gray12 bg-white2 fixed bottom-0 py-6">
                <div class="containermygo mx-auto ">
                    <div class="flex sm:flex-row flex-col w-full justify-center gap-x-2 items-center">
                        <div class="flex justify-center gap-x-2 items-center">
                            <div
                                class="pr-9 text-txtnamecomntpkyr font-inter font-medium dark:text-bgprogresb text-sixteen lg:flex hidden">
                                Elige 5 cursos para tu Plan Lite
                            </div>
                            <div class="flex flex-row   ">

                                <div
                                    class="xl:h-16 ml:h-16 lg:h-16 md:h-16 h-12 xl:w-16 ml:w-16 lg:w-16 md:w-16  w-12 relative">
                                    <svg class="mx-auto" viewBox="0 0 81 80" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M40.5001 80.0001C62.5915 80.0001 80.5002 62.0914 80.5002 40C80.5002 17.9085 62.5915 -0.00012207 40.5001 -0.00012207C18.4087 -0.00012207 0.5 17.9085 0.5 40C0.5 62.0914 18.4087 80.0001 40.5001 80.0001Z"
                                            fill="#999999" />
                                        ...
                                        <path
                                            d="M40.5001 72.192C58.2793 72.192 72.6921 57.7791 72.6921 40C72.6921 22.2208 58.2793 7.80798 40.5001 7.80798C22.721 7.80798 8.30811 22.2208 8.30811 40C8.30811 57.7791 22.721 72.192 40.5001 72.192Z"
                                            fill="#424F4F" />
                                        <path d="M52.4496 58.7395H21.6689V18.3262H47.1923L52.4496 24.5895V40.2117"
                                            stroke="white" stroke-width="1.42404" stroke-miterlimit="22.9256"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M47.1921 18.3262L46.2534 24.6682L52.4494 24.5895L47.1921 18.3262Z"
                                            stroke="white" stroke-width="1.42404" stroke-miterlimit="22.9256"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            d="M41.4626 34.5383L42.6641 28.606M23.0801 41.9061L26.9162 33.691L23.0801 41.9061ZM28.0696 33.5594L30.8957 37.9438L32.1593 37.9864L33.9366 34.5072L28.0696 33.5594ZM35.5521 33.5172L40.0252 35.6005L35.5521 33.5172Z"
                                ...
                                <div class="ml:px-2 px-1 absolute xl:mx-9 ml:mx-9 lg:mx-9 mx-5 -my-3">
                                    <button
                                        class="bg-transparent p-1 py-1 lg:px-1 px-4 text-pricingdarkstudents  focus:outline-none  rounded">
                            ...
                            <svg class="text-gray-600 dark:text-pricingdarkstudents" width="16" height="16"
                                viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.99983 2.66699V13.3337M13.3332 8.00032L2.6665 8.00032" stroke="currentcolor"
                            ...
                            <div class="sm:hidden flex flex-row   ">
                                ...
                                <div
                                    class="xl:h-16 ml:h-16 lg:h-16 md:h-16 h-12 xl:w-16 ml:w-16 lg:w-16 md:w-16  w-12 relative">
                                    <svg width="" height="" viewBox="0 0 41 40" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <rect x="1" y="0.5" width="39" height="39"
                                            rx="19.5" fill="#1B1B1D" />
                                        <path
                                            d="M19.5803 27.179C18.7791 27.179 18.0589 27.0256 17.4197 26.7188C16.7848 26.4077 16.2777 25.9815 15.8984 25.4403C15.5192 24.8991 15.3168 24.2812 15.2912 23.5866H17.2088C17.2557 24.1491 17.505 24.6115 17.9567 24.9737C18.4084 25.3359 18.9496 25.517 19.5803 25.517C20.0831 25.517 20.5284 25.402 20.9162 25.1719C21.3082 24.9375 21.6151 24.6158 21.8366 24.2067C22.0625 23.7976 22.1754 23.331 22.1754 22.8068C22.1754 22.2741 22.0604 21.799 21.8303 21.3814C21.6001 20.9638 21.2827 20.6357 20.8778 20.397C20.4773 20.1584 20.017 20.0369 19.4972 20.0327C19.1009 20.0327 18.7024 20.1009 18.3018 20.2372C17.9013 20.3736 17.5774 20.5526 17.3303 20.7741L15.5213 20.5057L16.2564 13.9091H23.4538V15.603H17.8991L17.4837 19.2656H17.5604C17.8161 19.0185 18.1548 18.8118 18.5767 18.6456C19.0028 18.4794 19.4588 18.3963 19.9446 18.3963C20.7415 18.3963 21.451 18.5859 22.0732 18.9652C22.6996 19.3445 23.1918 19.8622 23.5497 20.5185C23.9119 21.1705 24.0909 21.9205 24.0866 22.7685C24.0909 23.6165 23.8991 24.3729 23.5114 25.0376C23.1278 25.7024 22.5952 26.2266 21.9134 26.6101C21.2358 26.9893 20.4581 27.179 19.5803 27.179Z"
                                            fill="#CDD5DF" />
                                        <rect x="1" y="0.5" width="39" height="39"
                                            rx="19.5" stroke="#364152" />
                                    </svg>
                        ...
                        <div class="sm:hidden flex mx-auto">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11.8332 8.66642L8.49983 11.9998M8.49983 11.9998L5.1665 8.66642M8.49983 11.9998L8.49984 3.99976"
                        ...
                        <div class="sm:flex hidden">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M9.83333 3.33289L14.5 7.99955M14.5 7.99955L9.83333 12.6662M14.5 7.99955L2.5 7.99955"
                                    stroke="#9AA4B2" stroke-width="1.33333" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>

                        </div>
                        <div class="sm:pl-4 pl-0 sm:pt-0 pt-4">
                            <button
                                class="dark:bg-bcklightbuscador focus:outline-none bg-bgbtngreen font-medium font-inter text-sixteen px-6 h-11 text-green_especialidad dark:text-delesteicono rounded-lg">
                                Adquirir Plan Lite
                            </button>
                        </div>
